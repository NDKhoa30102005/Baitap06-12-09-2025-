...
<body>
    <div class="dashboard">
        <div class="card p-4 text-center">
            ...
            <a href="${pageContext.request.contextPath}/admin-user" class="btn btn-success">View User</a>
            <a href="${pageContext.request.contextPath}/admin-video" class="btn btn-success">View video</a>
